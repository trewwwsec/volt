...
import subrecon
from subrecon_models import ScanContext
...
class UpstreamDriftReliabilityTest(unittest.TestCase):
    ...
    def test_collect_ct_subdomains_handles_json_schema_drift(
        ...
        hosts, findings = subrecon.collect_ct_subdomains(
    ...
    @patch("subrecon.parse_bing_results")
    @patch("subrecon.fetch_url")
    ...
    @patch("subrecon.fetch_commoncrawl_results")
